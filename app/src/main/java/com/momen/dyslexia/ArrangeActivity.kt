...
class ArrangeActivity : AppCompatActivity() {
    ...
    var imgs2 = intArrayOf(R.drawable.story_g_1, R.drawable.story_g_2, R.drawable.story_g_3)
    var imgs3 = intArrayOf(R.drawable.stiry_hant_1, R.drawable.story_hant_2, R.drawable.story_hant_3, R.drawable.story_hant_4)
    var imgs4 = intArrayOf(R.drawable.story_baird_h_1, R.drawable.story_baird_h_2, R.drawable.story_baird_h_3, R.drawable.story_baird_h_4)
    var imgs5 = intArrayOf(R.drawable.story_man_1, R.drawable.story_man_2, R.drawable.story_man_3, R.drawable.story_man_4, R.drawable.story_man_5)
    var imgs6 = intArrayOf(R.drawable.story_tree_1, R.drawable.story_tree_2, R.drawable.story_tree_3, R.drawable.story_tree_4)
    var numbers1 = arrayListOf("1", "2", "3", "4")
    var numbers2 = arrayListOf("1", "2", "3")
    var numbers3 = arrayListOf("1", "2", "3","4")
    var numbers4 = arrayListOf("1", "2", "3","4")
    var numbers5 = arrayListOf("1", "2", "3","4","5")
    var numbers6 = arrayListOf("1", "2", "3","4")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arrange_next.setOnClickListener {
            ...
            if (index<=5){
                ...
                arrange_next.visibility= View.INVISIBLE
                arrange_recycler.visibility= View.INVISIBLE
                result()
                editor!!.putString("story","result = ${count} from 6")
                editor!!.commit()
